                  ...
                  <div class="logo text-center py-3 bg-primary rounded-top" >
                    ...
                    <div class="card border-0  rounded-0 pb-3">
                        <div class="card-body py-5 px-4">
                           ...
                           <form action="admin/app/sendmail.php" method="POST" id="fpassword_change">
                          <div class="mb-3">
                            <label class="form-label">Email address</label>
                            <input type="email" class="form-control" name="email" placeholder="Enter Your  Registered Email" >
                          </div>
                            <div class="text-center">
                              <button type="submit" name="submit" class="btn btn-primary rounded-0 " onclick="submit_fpassword()">Get OTP</button>
                            </div>
                        </div>
                    </div>
                </div>
