...
<div class="content-body mb-5 p-3">
    <div class="row">
        <div class="col-md-12">
            <div class="heading mb-4 d-flex align-items-center justify-content-between">
                ...
                <p class="m-0"><a href="dashboard.php" class="text-primary">Dashoboard </a> <span class="disable">/ Manage Customer </span></p>
            </div>
        </div>
    </div>
    <!-- Modal -->
    <section>
        <div class="container">
            ...
            <button type="submit1" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1">Add CSV</button>
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row" method="POST" action="app/cust-crud.php" id="customer_form">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="cdate" value="<?php echo date('Y-m-d'); ?>">
                                </div>
        ...
        <!-- Second model for csv file uploading -->
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="row" method="POST" action="app/csv_crud.php" id="customer_form" enctype="multipart/form-data">
                            <!-- form start -->
                            <div class="container">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="submit11" class="btn btn-primary" onclick="submitcust()" style="margin: 15px;">Submit</button>
                                    <input class="btn btn-primary" type="reset" value="Reset">
                                </div>
                                <!-- form End -->
                        </form>
                                ...
                                foreach ($record as $row) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="edit-customer.php?cid=<?php echo $row['cust_id']; ?>" class="btn btn-primary btn-sm "><i class="icon-line-awesome-edit fs-5"></i></a>
                                            <a href="app/cust-crud.php?delid=<?php echo $row['cust_id']; ?>" class="btn btn-danger btn-sm " onclick="return confirm('Do you really want to Delete ?');"><i class="icon-line-awesome-trash-o fs-5"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                    $cnt = $cnt + 1;
