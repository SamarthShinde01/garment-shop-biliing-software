          ...
          <div class="card-body py-5 px-4">
            ...
            <form action="app/login-crud.php" method="POST" id="fpassword_change">
              <div class="mb-3">
                ...
                <input type="password" class="form-control" name="pass1" placeholder="Enter New Password">
              </div>
              <div class="mb-3">
              ...
              <div class="text-center">
                <button type="update" name="update" class="btn btn-primary rounded-0 " onclick="submit_fpassword()">Update</button>
              </div>
          </div>
        </div>
      </div>
