...
<!-- <script data-require="jquery@3.1.1" data-semver="3.1.1" src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
 --> 
    <!-- <script src="script.js"></script> -->
                           ...
                           <div class="auto"> 
                           <form class="row" method="POST" action="app/purchase-crud.php" name="soid" id="saleorder_form" enctype="multipart/form-data">
                              
                                <div class="mb-3 col-md-6">

                                

                                    <label class="form-label">Supplier No:<span class="text-danger">*</span></label>
              ...
              <input type="date" class="form-control" autocomplete="off"  name="idate" value="<?php echo date('Y-m-d'); ?>" />
                             ...
                             <select class="form-select cust "  name="purchase" id="cust" >
                                        <?php
                                                 $cnt=1;
                                        ...
                                        <?php foreach ($record as $row) 
                                         { ?>
                                            <option value=" <?php echo $row['sup_id']?>"
                                                data-addrs="<?php echo $row['sup_add']?>"
                                                 data-email="<?php echo $row['sup_email']?>"
                                              data-mobile="<?php echo $row['sup_mobile']?>">
                                            <?php echo $row['sup_fname'].' '. $row['sup_lname']; ?>  <?php };?>
                                        </option>

                                     </select>
                                </div>
                                   <div class="mb-3 col-md-6">
                                    <label class="form-label ">Supplier Number<span class="text-danger">*</span></label>
                                 ...
                                 <div class="mb-3 col-md-6">
                                  ...
                                  <div style="margin-top: 20px;" class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                       ...
                                       <div style="margin-top: 20px;" class="form-group row control-group">
                             ...
                             <di style="margin-top: 20px;" class="form-group row">
