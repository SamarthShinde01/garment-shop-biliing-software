              ...
              <input type="date" class="form-control" autocomplete="off"  name="idate" value="<?php echo date('Y-m-d'); ?>" />
                                ...
                                <script>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-1 sr_no" style="margin-left:70px;">1</div>
                                        <div class="col-sm-3">
                                            <div class="col-sm-12">
                                                   <select name="product_id[]" class="form-control product_id select2" onchange="Product1(this);" required>
                                                     <option value="">--Select Material--</option>
                                                    <?php
                                                 $cnt=1;

                                    $stmt = $db->prepare("SELECT * from product INNER JOIN category ON product.cate_id=category.cate_id ; ");
                                   $stmt->execute();
                                   $record = $stmt->fetchAll();
                                   $i=1; ?>
                                                       <option></option>
                                        <?php foreach ($record as $row) 
                                         { ?>
                                            ...
                                            <div class="col-sm-2" id="product_loading1">
                                           <input type="text" class="form-control add" id="rate" name="rate[]" placeholder="Sale Price" required>
                                            </div>
                                            <div class="col-sm-2">
                ...
                <div class="copy hide" style="display:none;">
                         <div class="form-group control-group row subdiv">
                             <div class="col-sm-1 sr_no" style="margin-left:70px;"></div>
                                        <div class="col-sm-3">
                                            <div class="col-sm-12">
                                                   <select name="product_id[]" class="form-control product_id" onchange="Product(this);" required>
                                                    <option value="">--Select Material--</option>
                                                     <?php
                                                 $cnt=1;
                     ...
                     <!--  <input type="text" class="form-control" id="openning_stock" name="openning_stock[]" placeholder="Qty" required  onblur="GFG_Fun();" pattern="^[0-9]+$">
                      ...
                      <div class="col-sm-2" id="product_loading">
                     <input type="text" class="form-control add"  id="rate" name="rate[]" placeholder="Sale Price" required>
                      </div>
                      <div class="col-sm-2">
                     <input type="text" class="form-control total" id="total" name="total[]" placeholder="Total" readonly="">
    ...
    var drop_services= $(this).val();
            ...
            $.ajax({
                ...
                primary: function(data){
                 ...
                 currentRow.find('input[name^="aquantity"]').val(data['product']['i_prize']);
               ...
               currentRow.find('input[name^="quantity"]').val(0);
                currentRow.find('input[name^="quantity"]').attr('max',data['product']['i_prize']);
