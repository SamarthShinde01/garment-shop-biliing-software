    ...
    <div class="row">
        <div class="col-md-12">
            <div class="heading mb-4 d-flex align-items-center justify-content-between">
                ...
                <p class="m-0"><a href="dashboard.php" class="text-primary">Dashoboard </a> <span class="disable">/Purchase Report </span></p>
            </div>
        </div>
    </div>
                                    ...
                                    <table id="example" class="display table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['from_date']) && isset($_POST['to_date'])) {
                                                ...
                                                $stmt = $db->prepare("select * from product where submitted_date between '$from_date' AND '$to_date'  ");
                                                $stmt->execute();
